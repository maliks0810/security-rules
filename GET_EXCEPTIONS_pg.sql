...
DROP FUNCTION IF EXISTS public."GET_EXCEPTIONS"(varchar, text, text, text, text, text);
DROP FUNCTION IF EXISTS public."GET_EXCEPTIONS"(varchar, text, text, text, text, text, text);
DROP FUNCTION IF EXISTS public."GET_EXCEPTIONS"(varchar, text, text, text, text, text, text, text);
