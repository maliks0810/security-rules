-- Original RULE_BBG_COMPARE_MATURITY_DATE definition (recovered from
-- commit 59cc212). Re-run this file to restore the real rule after the
-- stub used during the "mark Complete" demo.
--
