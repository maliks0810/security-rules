...
INSERT INTO RULE_GROUP (NAME, DESCRIPTION, FLAG_STATUS_VISIBLE, FLAG_COMMENTS_VISIBLE, CREATED_DATE, CREATED_BY) VALUES
    ('Security Master', 'Security Master', TRUE, TRUE, CURRENT_TIMESTAMP(), CURRENT_USER());
