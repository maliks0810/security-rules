    ...
    res := (
        ...
        WHERE rg."RULE_GROUP_ID" IN (
            ...
            WHERE du."EMAIL" IS NOT NULL
              ...
              -- planner rejects the earlier EXISTS + LATERAL
              -- SPLIT_TO_TABLE formulation because the table function
              -- can't be correlated against outer columns; LIKE has
              -- no such restriction. Spaces are stripped so
              -- 'a@x.com, b@y.com' matches the same as 'a@x.com,b@y.com'.
