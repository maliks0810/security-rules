        ...
        "/v1/api/getExceptions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "RULE_CATALOG.NAME filter (reserved — RULE_2 does not carry RULE_CATALOG_ID for filtering yet)",
                        "name": "rule_catalog",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "RULE_2.RULE_NAME filter",
                        "name": "rule_name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Reserved (RULE_2 has no rule_group yet)",
                        "name": "rule_group",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "EXCEPTION_STATUS.NAME filter",
                        "name": "exception_status",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "SQL ILIKE pattern against RULE_2.RULE_NAME",
        ...
        "/v1/api/updateSecurityAssignTo": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "failed to update security assign to",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
